...
function App() {
  ...
  return (
    <>
      <Header />
      <main className='py-6 w-2/3 m-auto mt-20'>
        <div>
          <h1 className='whitespace-pre-line py-1 font-bold text-4xl uppercase bg-gradient-to-r from-purple-500 to-pink-500 inline-block text-transparent bg-clip-text'>Descrubi tu estilo único</h1>
          <h2 className='whitespace-pre-line font-medium text-lg'>Donde la moda se encuentra con la individualidad!</h2>
        ...
        <div className='mt-32 flex justify-between gap-4 box-border'>
        ...
        <div className='mt-20 flex justify-between gap-4 box-border'>
          <Cards name="Buzo Nike" desc="Black Jersy" discount="20%" price="60.000" image="/clothe/nike.jpg" />
          <Cards name="Remera Nike" desc="LA Newton" discount="20%" price="45.000" image="/clothe/nike2.webp" />
          <Cards name="PSG Retro" desc="Gray Edition" discount="20%" price="70.000" image="/clothe/nike3.webp" />
        </div>
